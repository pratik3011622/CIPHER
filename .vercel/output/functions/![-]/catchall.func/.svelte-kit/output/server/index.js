...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "149d8173-279a-4162-9c80-401aa3c5976e", e._sentryDebugIdIdentifier = "sentry-dbid-149d8173-279a-4162-9c80-401aa3c5976e");
  } catch (e2) {
  }
}();
...
${indent}}`);
    ...
    if (remote_cache) {
      ...
      serialized_remote_data = `${global2}.data = ${devalue.uneval(remote, replacer)};
