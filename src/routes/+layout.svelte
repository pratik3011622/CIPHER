...
{#if ["/","/leaderboard","/team","/readme"].includes($page.url.pathname)}
<div class="navbar">
    ...
    <a class="btn btn-ghost text-md" class:text-primary={$page.url.pathname==="/readme"} href="/readme"><ArrowUpRight/> Read Me</a>
