...
<title>Cipher Saga 3.0 - Read Me</title>

<div class="relative min-h-screen w-full flex flex-col items-center justify-start antialiased px-4 md:px-8 lg:px-16">
    <BackgroundBeams />

    <div class="relative z-10 text-center px-4 md:px-8 lg:px-16 max-w-6xl mx-auto py-12">
        ...
        <div class="bg-neutral-900 p-8 rounded-lg max-w-4xl mx-auto">
        ...
        <div class="bg-neutral-900 p-8 rounded-lg max-w-4xl mx-auto mt-8">
            <div class="pb-6">
                <h2 class="bg-gradient-to-b from-neutral-200 to-primary bg-clip-text text-center font-sans text-2xl font-bold text-transparent pb-2">
                    What is Cipher Saga 3.0?
                </h2>
                <p class="text-justify text-sm text-neutral-400">
            ...
            <div class="pb-6">
                ...
                <ul class="text-justify text-sm text-neutral-400 list-disc pl-5">
                    <li>
            ...
            <div class="pb-6">
                ...
                <ul class="text-justify text-sm text-neutral-400 list-disc pl-5">
                    ...
                    <li>
                        ...
                        via the <a href="https://discord.gg/Dm5zy3EaE4" class="text-blue-400 hover:text-blue-300"
            ...
            <div class="pb-6">
                ...
                <p class="text-justify text-sm text-neutral-400 pb-1">
                ...
                <p class="text-justify text-sm text-neutral-400 pb-1">
                    <i>
                        ...
                        be used. Sky's truly the limit.
                    </i>
                </p>
                <ul class="text-justify text-sm text-neutral-400 list-disc pl-5 pb-1">
                    <li>
            ...
            <div class="pb-6">
                <h2 class="bg-gradient-to-b from-neutral-200 to-primary bg-clip-text text-center font-sans text-l font-bold text-transparent pb-2">
                    Also a special thanks to Student Cell @ GSV and Epitome'25 organising committee for supporting us throughout
                </h2>
            </div>
        </div>
    </div>
